...
# user imports
from rekordbox_client.RB_handler import RB_handler_five_six
...
def main(args):
    ...
    mark = RB_handler_five_six(
        args.path_to_rb5, args.path_to_rb6, args.loc_of_musicfiles, keys_to_update
    )
